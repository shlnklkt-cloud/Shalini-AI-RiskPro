...
const WhatIfAnalysisPage = ({ propertyId, lob, propertyName }) => {
  ...
  if (loading) {
    return <div className="text-gray-400">Loading what-if analysis...</div>;
  }
  ...
  return (
    <div className="space-y-6" data-testid="whatif-page">
      <div>
        ...
        <p className="text-gray-400">What-If Analysis for <span className="font-semibold text-white">{lob}</span></p>
      </div>
