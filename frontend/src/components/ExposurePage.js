...
const ExposurePage = ({ propertyId, lob, propertyName }) => {
  ...
  return (
    <div className="space-y-6" data-testid="exposure-page">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="bg-blue-50 border-blue-200">
          <CardContent className="p-6">
            <p className="text-sm text-gray-700 mb-2 font-semibold">2024 Total Insurable Value</p>
            <p className="text-3xl font-bold text-gray-900">{exposure?.totalInsurableValue2024 || '$0M'}</p>
          </CardContent>
        </Card>

        <Card className="bg-green-50 border-green-200">
          <CardContent className="p-6">
            <p className="text-sm text-gray-700 mb-2 font-semibold">2025 Total Insurable Value</p>
            <p className="text-3xl font-bold text-gray-900">{exposure?.totalInsurableValue2025 || '$0M'}</p>
          </CardContent>
        </Card>
      </div>
      ...
      {/* Exposure Breakdown */}
      <div>
        <h4 className="text-xl font-bold text-gray-900 mb-4">Exposure Breakdown (2025)</h4>
